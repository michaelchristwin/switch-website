        ...
        <div className="h-20 max-w-7xl mx-auto px-margin-desktop flex items-center justify-between">
          <div className="flex items-center gap-4">
            <img
              ...
              src="https://lh3.googleusercontent.com/aida/AP1WRLsO2wVqpez-vOeWjJDYZAygE2D5Xgmjv19nRfRgVvLmaut4T76hEGkYgR4-0ysnyktaiFUR16uNqFlV0OTBhUnINeBOxU13IKKjTwJIKZ2fUC_Rq9GmOhfSqpWwdhwRMSPXeOpbVWxP2yb3g7Ru2x1dnr_LiMGKWMavJoZmz7rUjPvZV2seru813kdaVFcwazdw-WYuR37F5BkiPKp4Tq0W0IwY4UJ1Z1lwcKwvMSS4iY4ee243CyVEqw"
            />{' '}
          ...
          <section className="relative w-full min-h-[90vh] flex items-center bg-surface overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-margin-desktop w-full grid grid-cols-1 lg:grid-cols-12 gap-12 relative z-10 pt-20">
              <div className="col-span-1 lg:col-span-5 flex flex-col justify-center space-y-8 relative">
                <div className="absolute -left-8 top-1/2 -translate-y-1/2 font-label-caps text-[10px] text-outline [writing-mode:vertical-rl] tracking-widest uppercase hidden lg:block">
                  CUMULUS_SERIES // v2.4.1
                </div>
                <div>
